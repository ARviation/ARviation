...
public class PlaceOnPlane_v4 : MonoBehaviour
{
    [SerializeField]
    ...
    //{
    //    FlyControl_v3 control = spawnedObject.transform.Find("FlyControl").GetComponent<FlyControl_v3>();
    //    Debug.Log("take off" + "  action = " + control.action);
    //    //control.take_off();
    //    if (control.action == null)
    //    {
    //        control.take_off();
    //    }
    //    //trajectory traj = spawnedObject.transform.Find("trajectory").GetComponent<trajectory>();
    //    //if (traj.state == -1)
    //    //{
    //    //    traj.state = 1;
    //    //    traj.t = 0;
    ...
    //{
    //    FlyControl_v3 control = spawnedObject.transform.Find("FlyControl").GetComponent<FlyControl_v3>();
    //    Debug.Log("landing" + "  action = " + control.action);
    //    //control.landing();
    //    if (control.action == "free flight")
    //    {
    //        control.landing();
    //    }
    //    //trajectory traj = spawnedObject.transform.Find("trajectory").GetComponent<trajectory>();

...
public class ImageTracking_v2 : MonoBehaviour
{
    ...
    {
        // position
        airplane.transform.position = trackedImage.transform.position;
        ...
        airplane.transform.rotation = sampledRotation * Quaternion.Euler(airplane_angle_init);
